...
resource = json.load(request("https://www.transifex.com/api/2/project/traccar/resource/manager-android/?details"))

for language in resource["available_languages"]:
    code = language["code"]
    data = request("https://www.transifex.com/api/2/project/traccar/resource/manager-android/translation/" + code + "?file")
    if code == "en":
